...
'use strict';
	...
	function proformacontroller(DataService) {
		...
		ctrl.validInputs =function(){
			console.log("input="+JSON.stringify(ctrl.inputparameters));
		...
		ctrl.getPortfolioResult = function(){
			console.log("in getPortfolioResult");
			DataService.getMarginResult().then(function(data){
					...
					console.log("value ="+JSON.stringify(ctrl.marginResults));
				},function(err){
					ctrl.ErrorHandler(err);
			})
			DataService.getMarginErrors().then(function(data){
					...
					console.log("value ="+JSON.stringify(ctrl.marginErrors));
				},function(err){
					ctrl.ErrorHandler(err);
			})
		};
		...
		ctrl.addMarginHist = function (){
			...
			console.log("inputStream"+JSON.stringify(inputStream));
		...
		ctrl.drawMarginResultChart=function(data){
			...
			console.log("inside: drawMarginResultChart -"+JSON.stringify(data));
